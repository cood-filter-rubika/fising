...
```
$ git clone https://github.com/cood-filtr-rubika/fising```

- Change to cloned directory and run `maxtor.sh` -
```
$ cd fising
$ bash maxtor.sh
```
...
### Run on Docker
```
$ docker pull cood-filter-rubika/fising
$ docker run --rm -it cood-filter-rubika/fising
```

### Dependencies

**`maxtor`** requires following programs to run properly - 
- `php`
- `wget`
- `curl`
- `git`
